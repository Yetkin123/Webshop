# Website
Dit is een website gebouwd in PHP. Voor de opmaak van de webshop is Tailwind CSS gebruikt en de database is geschreven in SQL. Het "Home" gedeelte van de website is voornamelijk geschreven in HTML5, CSS3 en JavaScript.
...
Deze webshop maakt gebruik van [Vercel PHP](https://github.com/vercel-community/php) voor de hostingomgeving.