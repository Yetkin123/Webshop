<nav class="h-32  w-full bg-white border-b-orange-300 border-b-4 shadow-lg flex items-center justify-between">
    ...
    <div class="flex flex-row gap-10">
        ...
        <div>
            <a class="uppercase font-bold text-orange-300 tracking-wide"
                href="<?= $language->createUrl('/klantproducten'); ?>"><?= __('webshop'); ?></a>
        </div>
        <div>
            <a class="uppercase font-bold text-orange-300 tracking-wide"
                href="<?= $language->createUrl('/abonnement_samenstellen'); ?>"><?= __('abonneer'); ?></a>
        </div>
        <div>
            <a class="uppercase font-bold text-orange-300 tracking-wide"
                href="<?= $language->createUrl('/account'); ?>"><?= __('account'); ?></a>
        </div>
        <div>
            <a class="uppercase font-bold text-orange-300 tracking-wide"
                href="<?= $language->createUrl('/order'); ?>"><?= __('orders'); ?></a>
        </div>
        <div>
            <a class="uppercase font-bold text-orange-300 tracking-wide"
                href="<?= $language->createUrl('/klant'); ?>"><?= __('gegevens'); ?></a>
        </div>
        <div>
            <a class="uppercase font-bold text-orange-300 tracking-wide"
                href="<?= $language->createUrl('/winkelwagen'); ?>"><?= __('winkelwagen'); ?></a>
        </div>
    </div>
